...
def load_my_universe():
    ...
    df["Sector"]   = df["Industry"].map(MY_INDUSTRY_TO_SECTOR).fillna(df["Industry"])
...
def main():
    ...
    try:
        ...
        rrg_html = build_rrg_section(_rrg_d, _sl, _rrg_colors(_sl), market_code="MY")
    ...
    try:
        ...
        _db_save(stock_df, sec_str_df, market="my",
