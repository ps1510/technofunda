"""
╔══════════════════════════════════════════════════════════════════════════════╗
║  GERMANY MARKET ANALYSIS — HTML-ONLY EDITION  v1.0                     ║
...
def main():
    ...
    print("\n" + "═"*68)
    print("  GERMANY MARKET — HTML-ONLY EDITION  v1.0")
    ...
    try:
        ...
        rrg_html = build_rrg_section(_rrg_d, _sl, _rrg_colors(_sl), market_code="DE")
    ...
    try:
        ...
        html_path = os.path.join(SCRIPT_DIR, "DE.html")
        build_html_report(
    ...
    try:
        ...
        _db_save(stock_df, sec_str_df, market="DE",
    ...
    print(f"\n{'═'*68}")
    print(f"  ✅  COMPLETE!  |  ⏱ {elapsed:.0f}s  |  📄 DE.html")
