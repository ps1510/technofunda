...
INDIA_BREADTH_INDICES = {
    ...
    # --- Broad-based (additions) ---
    "Nifty SC 500":       {"yahoo":None,           "csv":"ind_NiftySmallcap500_list.csv"},
    "Microcap 250":       {"yahoo":None,           "csv":"ind_niftymicrocap250_list.csv"},
    "Midcap Select":      {"yahoo":None,           "csv":"ind_niftymidcapselect_list.csv"},
    "500 LMS EW":         {"yahoo":None,           "csv":"ind_nifty500LargeMidSmallEqualCapWeighted_list.csv"},
    "MidSmall 50:50":     {"yahoo":None,           "csv":"ind_NiftyMidSmallcap4005050_list.csv"},
    # --- Sectoral (new indices) ---
    "Capital Goods":      {"yahoo":None,           "csv":"ind_niftyCapitalGoods_list.csv"},
    "Nifty Power":        {"yahoo":None,           "csv":"ind_niftyPower_list.csv"},
    "Nifty Insurance":    {"yahoo":None,           "csv":"ind_niftyInsurance_list.csv"},
    "Nifty NBFC":         {"yahoo":None,           "csv":"ind_niftyNBFC_list.csv"},
    "Nifty Hospitals":    {"yahoo":None,           "csv":"ind_niftyHospitals_list.csv"},
    "Nifty Retail":       {"yahoo":None,           "csv":"ind_niftyRetail_list.csv"},
    "Nifty Telecom":      {"yahoo":None,           "csv":"ind_niftyTelecommunications_list.csv"},
    "Consumer Services":  {"yahoo":None,           "csv":"ind_niftyConsumerServices_list.csv"},
    "Comm. Transport":    {"yahoo":None,           "csv":"ind_niftyCommercialTransportServices_list.csv"},
    "Nifty Constr.":      {"yahoo":None,           "csv":"ind_niftyConstruction_list.csv"},
    "Housing Finance":    {"yahoo":None,           "csv":"ind_niftyHousingFinance_list.csv"},
    "REITs & Realty":     {"yahoo":None,           "csv":"ind_niftyREITsRealty_list.csv"},
    "Fin Svc 25/50":      {"yahoo":None,           "csv":"ind_niftyfinancialservices25-50list.csv"},
    "Fin Ex Bank":        {"yahoo":None,           "csv":"ind_niftyfinancialservicesexbank_list.csv"},
    # --- Thematic ---
    "India Defence":      {"yahoo":None,           "csv":"ind_niftyindiadefence_list.csv"},
    "India Mfg.":         {"yahoo":None,           "csv":"ind_niftyindiamanufacturing_list.csv"},
    "India Digital":      {"yahoo":None,           "csv":"ind_niftyindiadigital_list.csv"},
    "Nifty CPSE":         {"yahoo":"^CNXCPSE",    "csv":"ind_niftycpselist.csv"},
    "Nifty PSE":          {"yahoo":None,           "csv":"ind_niftypselist.csv"},
    "Nifty Energy":       {"yahoo":"^CNXENERGY",  "csv":"ind_niftyenergylist.csv"},
    "Nifty Infra":        {"yahoo":"^CNXINFRA",   "csv":"ind_niftyinfralist.csv"},
    "Nifty Commodities":  {"yahoo":None,           "csv":"ind_niftycommoditieslist.csv"},
    "Nifty Consumption":  {"yahoo":None,           "csv":"ind_niftyconsumptionlist.csv"},
    "Nifty Housing":      {"yahoo":None,           "csv":"ind_niftyhousing_list.csv"},
    "Nifty MNC":          {"yahoo":"^CNXMNC",     "csv":"ind_niftymnclist.csv"},
    "Nifty Services":     {"yahoo":None,           "csv":"ind_niftyservicelist.csv"},
    "Nifty Mobility":     {"yahoo":None,           "csv":"ind_niftymobility_list.csv"},
    "REITs & InvITs":     {"yahoo":None,           "csv":"ind_niftyREITs_InvITs_list.csv"},
    "India Tourism":      {"yahoo":None,           "csv":"ind_niftyindiatourism_list.csv"},
    "India Railways":     {"yahoo":None,           "csv":"ind_niftyIndiaRailwaysPSU_list.csv"},
    "EV & New Auto":      {"yahoo":None,           "csv":"ind_niftyEv_NewAgeAutomotive_list.csv"},
    "Core Housing":       {"yahoo":None,           "csv":"ind_niftyCoreHousing_list.csv"},
}
...
US_INDUSTRY_TO_SECTOR = {
    # ── 137 true Yahoo Finance industry names -> canonical GICS sector ──────
