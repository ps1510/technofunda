"""
╔══════════════════════════════════════════════════════════════════════════════╗
║  JAPAN MARKET ANALYSIS — GOOGLE SHEETS EDITION  v1.0                     ║
...
║  Timezone  : JST                              ║
║  Sheet URL : GOOGLE_SHEET_URL_JP env var                                   ║
╚══════════════════════════════════════════════════════════════════════════════╝
"""
...
SHEET_URL = (
    os.environ.get("GOOGLE_SHEET_URL_JP")
    or "https://docs.google.com/spreadsheets/d/YOUR_JP_SHEET_ID/edit"
)
GSCOPE = [
...
def write_sleeve_tab(ss, sleeve_df, market="JP"):
    title = "📋 RS Sleeves"
...
def main():
    ...
    print("\n" + "═"*68)
    print("  JAPAN MARKET — GOOGLE SHEETS EDITION  v1.0")
    ...
    write_sleeve_tab(ss, sleeve_df, "JP");                        time.sleep(TAB_DELAY)
